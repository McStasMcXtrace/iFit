...
function create_help(pw)
  ...
  'Scripts/Treatment', 'Scripts/Treatment/Sqw',...
  'Scripts/Models/scattering/powder_diffraction', ...
  'Scripts/Models/scattering/dynamic_structure_factors', ...
  'Applications/standalone','Applications/McStas', 'Applications/sliceomatic', ...
  'Applications/uiinspect',...
