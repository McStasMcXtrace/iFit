...
% Author:  E. Farhi <farhi@ill.fr>. % Version: $Revision: 1.49 $
...
function config = iLoad_config_load
  ...
  formats = {...
    ...
    { 'looktxt', '',    'Data (text format with fastest import method)',    ...
        '--headers --binary --fast --comment=NULL --silent --metadata=xlabel --metadata=ylabel --metadata=x_label --metadata=y_label', '','load_vitess_2d'}, ...
    { 'looktxt', '',    'Data (text format with fast import method)',       '--headers --binary --comment=NULL --silent','','load_vitess_2d'}, ...
