...
%
% Example: b=estruct(peaks); a=-b; c=a:.5:b; numel(c) == 4
% Version: $Date$ $Version$ $Author$
% See also estruct, estruct/floor, estruct/ceil, estruct/round, estruct/combine
...
if isa(a, 'estruct'), as = getaxis(a(1),'Signal'); as = as(:); else as = a; end
if isa(b, 'estruct'), bs = getaxis(b(1),'Signal'); bs = bs(:); else bs = b; end
