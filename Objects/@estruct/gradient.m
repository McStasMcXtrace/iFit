...
%   G = GRADIENT(A, DIM) computes the gradient (derivative) of estruct objects.
%   The returned value is an estruct array of the partials for dimension 
...
%
% Example: a=estruct(peaks); g=gradient(a,1); round(max(g))==1
% Version: $Date$ $Version$ $Author$
% See also estruct, estruct/diff, estruct/del2, diff, gradient, estruct/jacobian
