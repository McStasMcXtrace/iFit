function filename = private_saveas_stl(a, filename, format)
  if ndims(a) == 1    warning([ mfilename ': Object ' inputname(1) ' ' a.Tag ' 1D does not seem to be exportatble as a ' format ' file. Ignoring.' ]);
    return
  else
    ...
    % get Title
    T   = a.Name; if ~ischar(T), T=char(T); end
