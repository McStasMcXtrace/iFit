function filename = private_saveas_m(a, filename, name, options)
  NL = sprintf('\n');
  if ~isdeployed
  ...
  str = [ str ...
          ...
          '%   source:   ' a.Source NL ... 
          '%' NL ...
          '% Matlab ' version ' m-file ' filename ' saved on ' datestr(now) ' with estruct/saveas' NL ...
          '% To use/import data, type ''' name ''' at the matlab prompt.' NL ...
          '% You will obtain an estruct object (if you have estruct installed) or a structure.' NL ...
          '%' NL ...
