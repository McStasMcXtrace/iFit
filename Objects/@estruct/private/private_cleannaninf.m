function s=private_cleannaninf(s, ratio)
% private_cleannaninf: clean NaNs and Infs from a numerical field
%
...
if isa(s,'estruct')
  ...
  if numel(s) > 1
    ...
    s=set(s,'Signal',private_cleannaninf(get(s,'Signal'), ratio));
    s=set(s,'Error', private_cleannaninf(get(s,'Error'), ratio));
  end
