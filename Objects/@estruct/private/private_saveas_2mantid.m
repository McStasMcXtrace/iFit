function b = private_saveas_2mantid(a)
...
if numel(a) > 1
    b = [];
    for index=1:numel(a)
      b = [ b estruct_private_2mantid(a(index)) ];
    end
    return
end
...
if ~isfield(b.Data.mantid_workspace_1, 'program_name')
  b.Data.mantid_workspace_1.program_name=version(estruct, 'long');
...
if ~isfield(b.Data.mantid_workspace_1, 'title')
  b.Data.mantid_workspace_1.title = a.Name;
end
...
if isempty(match)
  b.Data.mantid_workspace_1.instrument.name=version(estruct);
...
if isempty(match)
  ...
  b.Data.mantid_workspace_1.process.version= version(estruct, 'long');
end
