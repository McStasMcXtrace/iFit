...
% [b...] = interp(s, ...) : interpolate object
%
%   @estruct/interp function to interpolate data sets.
%
...
%     b=interp(s, d) where 'd' is an estruct object computes 's' on the 'd' axes.
...
%         d: single object from which interpolation axes are extracted (estruct)
...
% ex:     a=estruct(peaks); b=interp(a, 'grid'); c=interp(a, 2);
%
