function [coh] = coherent(self, sq)
      ...
      coh = [ 'q_sav_coh = x; sq=' sq.Tag '_s; x = x./sqrt(abs(sq))' ] + self;  % prepend
      coh = sq.*coh; 
      coh.Expression{end+1} = 'x = q_sav_coh;';
      coh = iFunc_Sqw2D(coh); % this sets Parameters as needed
      coh.Name = [ mfilename '(' self.Name ',' sq.Name ')' ];
