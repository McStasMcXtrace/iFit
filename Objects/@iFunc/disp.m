...
if numel(s_in) > 1
  ...
  else           id=[ '<a href="matlab:doc  ' class(s_in) '">' class(s_in) '</a> (<a href="matlab:methods  ' class(s_in) '">methods</a>,<a href="matlab:doc(iFunc, ''' class(s_in) ''')">doc</a>,<a href="matlab:figure;subplot(' iname ');">plot</a>,<a href="matlab:char(' iname ')">code</a>)' ];
  end
