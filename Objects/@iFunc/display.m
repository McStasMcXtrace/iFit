...
else           id=[ '<a href="matlab:doc iData">iData</a> (<a href="matlab:methods iData">methods</a>,<a href="matlab:doc(iData,''iData'')">doc</a>,<a href="matlab:figure;plot(' iname ');">plot</a>,<a href="matlab:disp(' iname ');">more...</a>)' ];
end
if length(s_in) == 0
