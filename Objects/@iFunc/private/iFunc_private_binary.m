...
if isFa && isFb
  ...
  string.head = [ ...
    ...
    sprintf('%s_Parameters = this.Parameters(%i:%i); %% store 1st object parameter names\n', tmp_a, i1a, i2a), ...
    sprintf('%s_Parameters = this.Parameters(%i:%i); %% store 2nd object parameter names\n', tmp_b, i1b, i2b), ...
    sprintf('Parameters0   = this.Parameters; %% store initial object parameter names\n'), ...
    ...
    sprintf('this.Parameters = %s_Parameters; %% get 1st object Parameter names\n', tmp_a), ...
  ...
  string.tail = [ ...
    ...
    sprintf('this.Parameters = Parameters0; %% restore parameter names\n'), ...
