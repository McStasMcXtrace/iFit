...
contextmenu_snippet = [ ...
       ...
       'uimenu(tmp_cb.uicm, ''Label'',''Add Transparency'',''Callback'', ''alpha(0.7);'');' ...
       'set(gca, ''UIContextMenu'', tmp_cb.uicm);' ...
       'uimenu(tmp_cb.uicm, ''Label'',''Invert Transparency'',''Callback'', ''tmp_a = alphamap; if tmp_a(1) > tmp_a(end), alphamap rampdown; else alphamap tmp_cb.; end; clear tmp_a'');', ...
       'clear tmp_cb;' ];
