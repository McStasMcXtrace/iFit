...
% s = private_sumtrapzproj(a,dim, op) : computes the sum/trapz/camproj of iData objects elements
%
%   @iData/private_sumtrapzproj function to compute the sum/trapz/camproj of the elements of the data set
%
