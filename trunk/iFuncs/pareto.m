...
% ex:     y=pareto([1 0 1 1], -10:10); or y=pareto('identify') or p=pareto('guess',x,y);
%
...
function y =identify()
  ...
  parameter_names = {'Amplitude','Exponent','Width','Background'};
  %
  y.Type           = 'iFit fitting function';
  y.Name           = [ 'Pareto distribution function (1D) [' mfilename ']' ];
