...
% ex:     y=sinedamp([1 0 1 1], -10:10); or y=sinedamp('identify') or p=sinedamp('guess',x,y);
%
...
function y =identify()
  ...
  parameter_names = {'Amplitude','Phase_Shift','Period','Background','Decay'};
  %
  y.Type           = 'iFit fitting function';
  y.Name           = [ 'Damped Sine distribution function (1D) [' mfilename ']' ];
