...
% ex:     y=sine([1 0 1 1], -10:10); or y=sine('identify') or p=sine('guess',x,y);
%
...
function y =identify()
  ...
  parameter_names = {'Amplitude','Phase_Shift','Period','Background'};
  %
  y.Type           = 'iFit fitting function';
  y.Name           = [ 'Sine distribution function (1D) [' mfilename ']' ];
