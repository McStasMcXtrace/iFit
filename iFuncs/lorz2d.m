function signal=lorz2d(p, x, y, signal)
...
% ex:     signal=lorz2d([1 2 .5 .2 .3 30 .2], -2:.1:2, -3:.1:3); or p=lorz2d('guess',x,y,signal);
%
...
function signal =identify()
  ...
  parameter_names = {  'Amplitude' 'Centre_X' 'Center_Y' 'HalfWidth_X' 'HalfWidth_Y' 'Angle' 'Background' };
  %
  signal.Type           = 'iFit fitting function';
  signal.Name           = [ '2D Lorentzian function with tilt angle (2D) [' mfilename ']' ];
