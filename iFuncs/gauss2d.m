function signal=gauss2d(p, x, y, signal)
...
% ex:     signal=gauss2d([1 2 .5 .2 .3 30 .2], -2:.1:2, -3:.1:3); or p=gauss2d('guess',x,y,signal);
%
...
function signal =identify()
  ...
  signal.Name           = [ '2D Gaussian function with tilt angle (2D) [' mfilename ']' ];
