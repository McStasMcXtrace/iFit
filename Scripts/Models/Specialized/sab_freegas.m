function signal=sab_freegas(varargin)
% model = sab_freegas(p, alpha ,beta, {signal}) : Free-gas/recoil dispersion(Q)
%
%   iFunc/sab_freegas: a 2D S(alpha,beta) with a free-gas/recoil dispersion
%
...
%     sab(p, alpha, beta)
%
% input:  p: sab_freegas model parameters (double)
...
signal.Name           = [ 'sab_freegas dispersion(Q) free-gas/recoil dispersion [' mfilename ']' ];
