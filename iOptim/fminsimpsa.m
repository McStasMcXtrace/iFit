function [pars,fval,exitflag,output] = fminsimpsa(fun, pars, options, constraints, ub)
...
% calls the optimizer
[pars,fval,exitflag,output] = SIMPSA(fun,pars(:),constraints.min(:),constraints.max(:),options);
